...
(** ** Dependent types
    ...
    Fixpoint vappend {A : Type} {n1 n2 : nat}
        ...
        | vnil => (* n1 = 0*) (*n1+n2 = 0 n2 = n2*) ls2


        | vcons a ls1' => (*n1 = S n1'*) (*n1 + n2 = S n1' + n2 = def S (n1' + n2)*)
    ...
    *)
    ...
    Definition foo_commutativity {A : Set}
    ...
    | @vcons _ n' a ls' =>
        ...
        | eq_refl _ => eq_refl (S (length (to_list ls')))
        end
    end.
